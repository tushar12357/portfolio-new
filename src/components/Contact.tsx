    ...
    <div className="container mx-auto px-4 md:px-6">
      <div className="text-center mb-16 fade-in">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
          Currently open for full-time roles, freelance projects, or
          collaboration on AI & full-stack products.
        </p>
      </div>
        ...
        <div className="lg:w-1/3 slide-in-left">
          <div className="bg-gradient-to-br from-indigo-900 to-purple-900 p-8 rounded-lg shadow-xl border border-indigo-700">
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a
                    href="mailto:tusharcdry@gmail.com"
                    className="text-gray-300 hover:text-white"
                  >
                    tusharcdry@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-center">
            ...
            <div className="mt-10 flex space-x-4">
              <a
                href="https://linkedin.com/in/tushar-chaudhary-4a49621a3"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-indigo-800/50 rounded-full flex items-center justify-center hover:bg-indigo-700 transition hover:scale-110"
              >
                <Linkedin size={22} />
              </a>
              <a
        ...
        <div className="lg:w-2/3 slide-in-right">
          ...
          >
            ...
            <textarea
              ...
              required
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-md mb-6 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white"
            ></textarea>

            {/* Success/Error Feedback */}
            {status === "success" && (
              <p className="text-green-400 font-medium mb-4 text-center">
